...
const fkontak = {
    ...
    message: {
        contactMessage: {
            displayName: "© SAMURAI_SPIRIT-MD",
            vcard: `BEGIN:VCARD\nVERSION:3.0\nN:XL;Meta AI;;;\nFN:Meta AI\nitem1.TEL;waid=94754871798:94754871798\nitem1.X-ABLabel:Ponsel\nEND:VCARD`,
            sendEphemeral: false,
        },
    },
};
...
const number = conn.user.id.split(':')[0].replace(/@s\.whatsapp\.net$/, '');
    ...
    const baseButtons = [
      ...
      { buttonId: prefix + 'ping', buttonText: { displayText: 'SAMURAI POWER' }, type: 1 },
...
I am alive now 🎈\n✨ Thank you for choosing \`Samurai-Spirit-MD\` — your trusted WhatsApp Multi-Device Bot! ✨
*┌────────────────────┐*
*├ \`⏰ 𝐔𝐩𝐭𝐢𝐦𝐞\`* : ${rtime}
*├ \`🚨 𝐇𝐨𝐬𝐭\`* : ${hostname}
...
*├ \`👤 𝐔𝐬𝐞𝐫\`* : ${pushname}
*├ \`⛵ 𝐑𝐚𝐦 𝐮𝐬𝐬𝐚𝐠𝐞\`* : ${ramUsage}
*├ \`⛩️𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫\`* : *LOAD DILISHA*
*├ \`🧬 𝐕𝐞𝐫𝐬𝐢𝐨𝐧\`* : 2.0.0
*└────────────────────┘*
*┌────────────────────┐*
*├ 👨‍💻𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑* :
  \`• API Developer\` : 𝐋OAD 𝐃ILISHA
*└────────────────────┘*
...
*💛 Thank you for trusting SAMURAI_SPIRITS-MD!*`,
...
I am *SAMURAI_SPIRITS-MD* Userbot🎈
*┌────────────────────┐*
*├ \`⏰ 𝐔𝐩𝐭𝐢𝐦𝐞\`* : ${rtime}
*├ \`🚨 𝐇𝐨𝐬𝐭\`* : ${hostname}
*├ \`🎡 𝐏𝐫𝐞𝐟𝐢𝐱\`* : ${config.PREFIX}
...
await sleep(1000)
let caps = jet.message.audioMessage.caption || "𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐒𝐏𝐈𝐑𝐈𝐓𝐒 𝐌𝐃"
...
const jet = {
        ...
        await fs.promises.writeFile("./" + type.ext, buff);
	await sleep(1000)
	let caps = jet.message.videoMessage.caption || "𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐒𝐏𝐈𝐑𝐈𝐓𝐒 𝐌𝐃"
...
await fs.promises.writeFile("./" + type.ext, buff);
await sleep(1000)
let caps = jet.message.imageMessage.caption || "𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐒𝐏𝐈𝐑𝐈𝐓𝐒 𝐌𝐃"
 const jid = q || from
...
cmd({
    ...
    try {
        ...
        let text = `*👨‍💻 ${config.BOT_NAME || "SAMURAI_SPIRITS-MD"} Developer Team*\n\n`;

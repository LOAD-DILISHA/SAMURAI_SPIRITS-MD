...
const caption = `*_⚙️ 𝐒𝐀𝐌𝐔𝐑𝐀𝐈 𝐒𝐄𝐓𝐓𝐈𝐍𝐆 𝐈𝐍𝐅𝐎 ⚙️_*`
const listMessage = {
text: `*_⚙️ SAMURAI SETTINGS INFO ⚙️_*
...
let caption = `*\`↔️ SAMURAI CHANGE DATABASE INFO ↔️\`*
...
const buttons = [
 ...
 if (config.BUTTON === 'true') {
      const listData = {
        ...
        sections: [
          {
            title: "SAMURAI_SPIRITS-MD-DATABASE-INFO",
            rows: [
